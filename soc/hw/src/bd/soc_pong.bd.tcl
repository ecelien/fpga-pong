...
################################################################
# This is a generated script based on design: soc_pong
#
...
xilinx.com:user:image_gen_2_axi:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: image_gen_2_axi_0, and set properties
  set image_gen_2_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:image_gen_2_axi:1.0 image_gen_2_axi_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins image_gen_2_axi_0/S00_AXI]
  ...
  connect_bd_net -net image_gen_2_axi_0_Hsync  [get_bd_pins image_gen_2_axi_0/Hsync] \
  [get_bd_ports Hsync]
  connect_bd_net -net image_gen_2_axi_0_Vsync  [get_bd_pins image_gen_2_axi_0/Vsync] \
  [get_bd_ports Vsync]
  connect_bd_net -net image_gen_2_axi_0_vgaBlue  [get_bd_pins image_gen_2_axi_0/vgaBlue] \
  [get_bd_ports vgaBlue]
  connect_bd_net -net image_gen_2_axi_0_vgaGreen  [get_bd_pins image_gen_2_axi_0/vgaGreen] \
  [get_bd_ports vgaGreen]
  connect_bd_net -net image_gen_2_axi_0_vgaRed  [get_bd_pins image_gen_2_axi_0/vgaRed] \
  [get_bd_ports vgaRed]
  ...
  [get_bd_pins image_gen_2_axi_0/s00_axi_aclk]
  ...
  [get_bd_pins image_gen_2_axi_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs image_gen_2_axi_0/S00_AXI/S00_AXI_reg] -force
